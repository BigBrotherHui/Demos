...
namespace itk
{
	...
	public:
		...
		void SetActive(bool b1, bool b2)
		{
			m_bInterpolator1 = b1;
			m_bInterpolator2 = b2;
		}

		void SetMask(bool b1, bool b2)
		{
			m_bInterpolator1 = b1;
			m_bInterpolator2 = b2;
		}
		...
		void SetInitialTransform(TransformParametersType InitialTransform)
		{
	...
	protected:
		...
		bool
			CalculateMI(FixedImageConstPointer myfixed,
				FixedImageConstPointer myfixed2,
				int                    iHistogramBins,
				double                 dMarginalScale,
				double &               dEntropy) const;
	private:
		bool m_SubtractMean;
		bool m_bInterpolator1;
		bool m_bInterpolator2;
		
		TransformParametersType m_InitialTransform;
	};

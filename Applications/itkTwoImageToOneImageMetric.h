...
public:
  ...
  using InterpolatorType = itk::SiddonJacobsRayCastInterpolateImageFunction<MovingImageType, CoordinateRepresentationType>;
  ...
  /** Connect the Fixed Image.  */
  itkSetConstObjectMacro(FixedMask1, FixedImageType);

  /** Connect the Fixed Image.  */
  itkSetConstObjectMacro(FixedMask2, FixedImageType);
  ...
  void
  SetDrrMask(float* mask1, float*mask2)
  {
	  m_Drrmask1 = mask1;
	  m_Drrmask2 = mask2;
  }
...
protected:
  ...
  FixedImageConstPointer  m_FixedMask1;
  FixedImageConstPointer  m_FixedMask2;

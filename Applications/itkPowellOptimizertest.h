...
namespace itk
{
	...
	class PowellOptimizerTest : public SingleValuedNonLinearOptimizer
	{
	public:
		...
		using Self = PowellOptimizerTest;
		...
		itkTypeMacro(PowellOptimizerTest, SingleValuedNonLinearOptimizer);
	...
	protected:
		PowellOptimizerTest();
		PowellOptimizerTest(const PowellOptimizerTest &);
		~PowellOptimizerTest() override;
		void

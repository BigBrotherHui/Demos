...
public:
	...
	std::vector<double> uniformParametrization(const std::vector<Eigen::Vector3d>& dataPoints) const;
	std::vector<double> chordalParametrization(const std::vector<Eigen::Vector3d>& dataPoints) const;
	std::vector<double> centripetalParametrization(const std::vector<Eigen::Vector3d>& dataPoints) const;
	...
	// Parametrization
	std::vector<double> curveParametrization(const std::vector<Eigen::Vector3d>& dataPoints) const;
	std::vector<std::vector<double>>
	surfaceParametrization(const std::vector<std::vector<Eigen::Vector3d>>& dataPoints) const;

	// Interpolation
	std::vector<Eigen::Vector3d> interpolateControlPoints(const BSpline& bsp,
	...
	// approximation
	std::vector<Eigen::Vector3d> approximateControlPoints(const BSpline& bsp,
	                                                int h,
	                                                const std::vector<Eigen::Vector3d>& dataPoints,
	                                                const std::vector<double>& ts) const;

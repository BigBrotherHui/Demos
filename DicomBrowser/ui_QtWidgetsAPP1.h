...
public:
    ...
    QVTKOpenGLNativeWidget*qvtkWidget_later;
    QVTKOpenGLNativeWidget*qvtkWidget_before;
    ...
    void setupUi(QMainWindow *QtWidgetsAPP1Class)
    {
        ...
        qvtkWidget_later = new QVTKOpenGLNativeWidget(frame_ImageShow);
        qvtkWidget_later->setObjectName(QStringLiteral("qvtkWidget_later"));
        qvtkWidget_later->setGeometry(QRect(20, 390, 521, 351));
        qvtkWidget_before = new QVTKOpenGLNativeWidget(frame_ImageShow);

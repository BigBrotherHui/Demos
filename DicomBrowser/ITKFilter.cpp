...
//在QVTKOpenGLNativeWidget中绘制dcm格式的image
void ITKFilter::Painting(IntImageType::Pointer image,QVTKOpenGLNativeWidget *QVTKOpenGLNativeWidget)
{
	...
	QVTKOpenGLNativeWidget->renderWindow()->AddRenderer(renderer);
	...
	viewer->SetRenderWindow(QVTKOpenGLNativeWidget->renderWindow());
	viewer->SetRenderer(renderer);//设置渲染场景
	//viewer->SetupInteractor(QVTKOpenGLNativeWidget->GetInteractor());//交互方式
	renderer->ResetCamera();
	renderer->DrawOn();
	renderer->SetBackground(1, 1, 1);
	QVTKOpenGLNativeWidget->renderWindow()->Render();
}
//在QVTKOpenGLNativeWidget中绘制JPEG格式的image
void ITKFilter::Painting(CharImageType::Pointer image, QVTKOpenGLNativeWidget*QVTKOpenGLNativeWidget)
{
	...
	vtkSmartPointer<vtkImageViewer2> viewer = vtkSmartPointer<vtkImageViewer2>::New();
	vtkSmartPointer<vtkRenderer> renderer = vtkSmartPointer<vtkRenderer>::New();
	QVTKOpenGLNativeWidget->GetRenderWindow()->AddRenderer(renderer);
	...
	viewer->SetInputData(flip->GetOutput());
	viewer->UpdateDisplayExtent();
	viewer->SetRenderWindow(QVTKOpenGLNativeWidget->GetRenderWindow());
	viewer->SetRenderer(renderer);//设置渲染场景
	//viewer->SetupInteractor(QVTKOpenGLNativeWidget->GetRenderWindow()->GetInteractor());//交互方式
	renderer->ResetCamera();
	renderer->DrawOn();
	renderer->SetBackground(1, 1, 1);
	QVTKOpenGLNativeWidget->GetRenderWindow()->Render();
}

//二进制中值滤波 
void ITKFilter::myBinaryMedianImageFilter(IntImageType::Pointer image,QVTKOpenGLNativeWidget *QVTKOpenGLNativeWidget)
{
	...
	ITKFilter::Painting(outputImage, QVTKOpenGLNativeWidget);
}

void ITKFilter::myErodeFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget *QVTKOpenGLNativeWidget)
{
...
void ITKFilter::myDilateFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget *QVTKOpenGLNativeWidget)
{
	using StructuringElementType =
		itk::BinaryBallStructuringElement<IntPixelType, Dimension>;
...
void ITKFilter::myShiftFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget * QVTKOpenGLNativeWidget)
{
...
void ITKFilter::myCannyFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget * QVTKOpenGLNativeWidget)
{
	using IntensityWindowingImageFilterType = itk::IntensityWindowingImageFilter <IntImageType, IntImageType>;
	IntensityWindowingImageFilterType::Pointer intensityFilter = IntensityWindowingImageFilterType::New();
	intensityFilter->SetInput(image);
...
void ITKFilter::myGaussianFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget * QVTKOpenGLNativeWidget)
{
	using FilterType =
...
void ITKFilter::myDiscreteFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget * QVTKOpenGLNativeWidget)
{
...
void ITKFilter::myThresholdFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget * QVTKOpenGLNativeWidget)
{
...
void ITKFilter::mySigmoidFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget * QVTKOpenGLNativeWidget)
{
...
void ITKFilter::myNormalFilter(IntImageType::Pointer image, QVTKOpenGLNativeWidget * QVTKOpenGLNativeWidget)  
{

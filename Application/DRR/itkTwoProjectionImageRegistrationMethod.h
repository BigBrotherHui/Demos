...
public:
  ...
  void
  SetFixedImage1(const FixedImageType * fixedImage1, const FixedImageType * fixedMask1);
  void
  SetFixedImage2(const FixedImageType * fixedImage2, const FixedImageType * fixedMask2);

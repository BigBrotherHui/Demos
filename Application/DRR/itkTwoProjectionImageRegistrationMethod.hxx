...
TwoProjectionImageRegistrationMethod<TFixedImage, TMovingImage>::Initialize()
{
  ...
  m_Metric->SetFixedMask1(m_FixedMask1);
  m_Metric->SetFixedMask2(m_FixedMask2);

  m_Metric->SetDrrMask(m_Drrmask1, m_Drrmask2);
...
template <typename TFixedImage, typename TMovingImage>
void
TwoProjectionImageRegistrationMethod<TFixedImage, TMovingImage>::SetFixedImage1(const FixedImageType * fixedImage1, const FixedImageType * fixedmask1)
{
  ...
  if (this->m_FixedMask1.GetPointer() != fixedmask1)
  {
	  this->m_FixedMask1 = fixedmask1;

	  //// Process object is not const-correct so the const_cast is required here
	  //this->ProcessObject::SetNthInput(0, const_cast<FixedImageType *>(m_FixedMask1));
...
template <typename TFixedImage, typename TMovingImage>
void
TwoProjectionImageRegistrationMethod<TFixedImage, TMovingImage>::SetFixedImage2(const FixedImageType * fixedImage2, const FixedImageType * fixedmask2)
{
  ...
  if (this->m_FixedMask2.GetPointer() != fixedmask2)
  {
	  this->m_FixedMask2 = fixedmask2;

	  //// Process object is not const-correct so the const_cast is required here
	  //this->ProcessObject::SetNthInput(0, const_cast<FixedImageType *>(m_FixedMask2));

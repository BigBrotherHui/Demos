...
class vtkImageViewer2My : public vtkObject
{
public:
	static vtkImageViewer2My *New();
	vtkTypeMacro(vtkImageViewer2My, vtkObject);
	...
	{
		this->SetSliceOrientation(vtkImageViewer2My::SLICE_ORIENTATION_XY);
	};
	virtual void SetSliceOrientationToYZ()
	{
		this->SetSliceOrientation(vtkImageViewer2My::SLICE_ORIENTATION_YZ);
	};
	virtual void SetSliceOrientationToXZ()
	{
		this->SetSliceOrientation(vtkImageViewer2My::SLICE_ORIENTATION_XZ);
	};
...
protected:
	...
	friend class vtkImageViewer2MyCallback;

private:
	vtkImageViewer2My(const vtkImageViewer2My&) = delete;
	void operator=(const vtkImageViewer2My&) = delete;
};
